...
func NewUserRepository(database *gorm.DB) _categoryDomain.CategoryRepository {
...
func (repo *categoryRepositoryDatabase) DeleteCategory(ctx context.Context, category_id int) (_categoryDomain.CategoryDomain, error) {
	var categoryResult Category
